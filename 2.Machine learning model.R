...
indicator_specs <- list(
  C_seq = list(
    label = "C_seq",
    target = "CUE",
    data_file = "model_training/C_seq.csv",
  ...
  yield = list(
    label = "yield",
    target = "yield",
    data_file = "model_training/yield.csv",
  ...
  CO2 = list(
    label = "CO2",
    target = "CO2",
    data_file = "model_training/CO2.csv",
  ...
  N2O = list(
    label = "N2O",
    target = "N2O",
    data_file = "model_training/N2O.csv",
...
read_indicator_data <- function(spec) {
  ...
  if (status_col %in% names(dat)) {
    stop(
      ...
      "and use the processed model_training CSV files."
    )
  }
